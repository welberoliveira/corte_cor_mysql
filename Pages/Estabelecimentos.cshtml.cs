    ...
    public class EstabelecimentosModel : PageModel
    {
            ...
            public List<OptionItem> Portes { get; } = new()
        {
            ...
            public void OnGet()
            {
                ...
                {
                    AvisoBaseCnpj = "A base de estabelecimentos do CNPJ não está instalada neste banco. " +
                                    "A tela foi mantida acessível, mas a pesquisa só funcionará depois que as tabelas CNPJ forem importadas.";
                    Total = 0;
                    Itens = new();
            ...
            public IActionResult OnGetExportCsv()
            {
                ...
                if (!BaseCnpjDisponivel)
                {
                    return Content("A base de estabelecimentos do CNPJ não está instalada neste banco.");
                }
